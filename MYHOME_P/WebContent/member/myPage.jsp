...
<div class="myPage">
	<form id="f" method="post">
		...
		<br/>
		<button type="button" id="updatePwBtn"  class="btn btn-outline-dark">CHANGE PASSWORD</button>
		<!-- <input id="updatePwBtn" type="button" value="Change your password" /> --> &nbsp;&nbsp;
		<button type="button" id="updateInfoBtn" class="btn btn-outline-dark">UPDATE</button>
